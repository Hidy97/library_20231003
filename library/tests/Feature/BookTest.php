...
class BookTest extends TestCase
{
    ...
    {
        //$response = $this->post('/api/books', ['author' => 'Mark Lawrence', 'title'=> 'Tövisek hercege']);
        //$response = $this->post('/api/books', ['author' => 'Francz Kafka', 'title'=> 'Átváltozás']);
        $response = $this->post('/api/books', ['author' => 'Mark Lawrence', 'title' => 'Tövisek királya']);
        $response->assertStatus(200);
    }
